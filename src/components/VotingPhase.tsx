...
export default function VotingPhase() {
  const { room, playerId, castVote, castCibleVote, forceReveal, policeBlock, fouActivate, error, clearError } = useGame();
              ...
              <>
                ...
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-xl font-black flex items-center gap-2">
                    <Target size={18} className="text-pink-400" /> À qui ce son était-il destiné ?
                  </h3>
                </div>
                ...
                <div className="mt-4">
                  {isBlocked ? (
                  ...
                  ) : (pendingVote && pendingTarget) ? (
                    <button onClick={() => castCibleVote(pendingVote, pendingTarget)}
                    ...
                    <p className="text-center text-gray-500 text-sm">Sélectionne les deux réponses pour confirmer</p>
                  )}
                </div>
              </>
            ) : (
