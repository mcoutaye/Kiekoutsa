...
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS police_blocks_used INTEGER DEFAULT 0;
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS fou_activated BOOLEAN DEFAULT FALSE;

ALTER TABLE rooms ADD COLUMN IF NOT EXISTS fou_activations_used INTEGER DEFAULT 0;
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS target_assignments JSONB DEFAULT NULL;
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS target_votes JSONB NOT NULL DEFAULT '{}';
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS current_round INTEGER NOT NULL DEFAULT 1;

-- Prompt mode columns
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS prompts JSONB NOT NULL DEFAULT '{}';
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS prompt_order JSONB NOT NULL DEFAULT '[]';
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS prompt_submissions JSONB NOT NULL DEFAULT '{}';
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS prompt_votes JSONB NOT NULL DEFAULT '{}';
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS player_prompt_progress JSONB NOT NULL DEFAULT '{}';
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS current_prompt_index INTEGER NOT NULL DEFAULT 0;
ALTER TABLE rooms ADD COLUMN IF NOT EXISTS prompt_results JSONB NOT NULL DEFAULT '[]';
